...
{
    public class WcfServiceClientExtensions : IServiceExtensions//, IServiceAsync
    {
        //private IService Service;
        //private IServiceAsync ServiceAsync;
        private int tryConnectCount;
        private List<ServiceExtensionsInfo> listServicePool;
        private int servicePoolMaxCount;

        public WcfServiceClientExtensions()
        {
        ...
        public WcfServiceClientExtensions(string bindingName, string bindingConfigName, string address) : this()
        {
